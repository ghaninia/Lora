...
class DiscountController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $information = [
            'title' => trans('lora.discounts.label'),
            'desc'  => trans('lora.discounts.desc'),
            'breadcrumb' => [
                trans('lora.discounts.label') => null
            ]
        ];
    ...
    public function store(DiscountStore $request)
    {
        ...
        return RepMessage(trans('lora.messages.success.discounts.create'));
    }
    ...
    public function show(Discount $discount, Request $request)
    {
        ...
        $information = [
            'title' => trans('lora.discounts.show_label'),
            'desc'  => trans('lora.discounts.show_desc'),
            'breadcrumb' => [
                trans('lora.discounts.label') => route('dashboard.discount.index'),
                $discount->code => null
            ]
        ];
    ...
    public function update(DiscountUpdate $request, Discount $discount)
    {
        ...
        return redirect()->route("dashboard.discount.show", ['discount' => $discount->code])->with([
            'message' => trans('lora.messages.success.discounts.update'),
            'status' => true,
        ]);
    }
