...
class RoleController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $information = [
            'title' => trans('lora.roles.all.text'),
            'desc'  => trans("lora.roles.all.desc"),
            'breadcrumb' => [
                trans("lora.roles.all.text") => null
            ]
        ];
    ...
    public function create()
    {
        ...
        $information = [
            'title' => trans('lora.roles.create.text'),
            'desc'  => trans("lora.roles.create.desc"),
            'breadcrumb' => [
                trans('lora.roles.all.text') => route('dashboard.role.index'),
                trans("lora.roles.create.text") => null
            ]
        ];
    ...
    public function store(RoleStore $request)
    {
        ...
        return RepMessage(trans('lora.messages.success.roles.update'), true, 'dashboard.role.index');
    }
    ...
    public function edit(Role $role)
    {
        ...
        $information = [
            'title' => trans('lora.roles.edit.text'),
            'desc'  => trans("lora.roles.edit.desc"),
            'breadcrumb' => [
                trans('lora.roles.all.text') => route('dashboard.role.index'),
                trans("lora.roles.edit.text") => null
            ]
        ];
    ...
    public function update(RoleUpdate $request, Role $role)
    {
        ...
        $role->permissions()->sync($request->input('permissions', []));
        $role->update($update);
        return RepMessage(trans('lora.messages.success.roles.update'));
    }
    ...
    public function destroy(Role $role)
    {
        if (!$role->default) {
            ...
            return RepMessage(trans('lora.messages.success.roles.delete'));
        }
