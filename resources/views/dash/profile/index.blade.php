                            ...
                            @if(\Request::input("index") == "password")
                                ...
                                <div class="col-xl-12">
                                    <div class="submit-field">
                                        <h5>{{ trans("dash.profile.password") }}</h5>
                                ...
                                <div class="col-xl-12 margin-bottom-20">
                                    <div class="submit-field">
                                        <h5>{{ trans("dash.profile.password_confirmation") }}</h5>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="submit-field">
                                                ...
                                                <select name="theme" class="selectpicker with-border" data-size="7" title="{{ trans('dash.profile.select_one_color') }}" data-live-search="true">
                                                ...
                                                <div class="account-type">
                                                    @foreach(['male' => 'mdi-male-alt' , 'female' => 'mdi-female' ] as $gender => $icon )
                                                        <div>
                                                            ...
                                                            <label for="{{ $gender }}-radio" class="ripple-effect-dark">{{ trans("dash.profile.genders.$gender") }}</label>
                                                        </div>
                                                    @endforeach
                                                </div>
