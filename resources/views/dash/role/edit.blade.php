...
@section('main')
    <div class="dashboard-box">
        <!-- Headline -->
        <div class="headline">
            <h3><i class="icon-material-outline-business-center"></i>{{ trans('dash.roles.edit.text_with_attr' , ['attribute' => $role->name ]) }}</h3>
        </div>
        <div class="content">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="row">
                                    ...
                                    <div class="col-xl-12">
                                        <div class="submit-field">
                                            <h5>{{ trans('dash.roles.permissions.text') }}</h5>
                                            @if($permissions->isEmpty())
                                                <div class="notification error closeable">
                                                    <p>{{ trans('dash.roles.permissions.without') }}</p>
                                                    <a class="close"></a>
                                                </div>
                                            @else
                                                <select data-selected-text-format="count > 1" class="selectpicker with-border" name="permissions[]" multiple title="{{ trans('dash.roles.permissions.desc') }}" data-live-search="true">
                                    ...
                                    <div class="col-xl-12">
                                        <div class="checkbox">
                                            ...
                                            <label for="default"><span class="checkbox-icon"></span>{{ trans('dash.roles.default.desc') }}</label>
