            ...
            <div class="dashboard-box margin-top-0">
                ...
                <div class="content with-padding padding-bottom-0">
                    <div class="row">
                        ...
                        <div class="col-auto">
                            <div class="avatar-wrapper" data-tippy-placement="bottom" title="{{ trans('dash.profile.choose_picture') }}">
                        ...
                        <div class="col">
                            <div class="submit-field">
                                <h5>{{ trans("dash.profile.firstname") }}</h5>
                            ...
                            <div class="submit-field">
                                <h5>{{ trans("dash.profile.lastname") }}</h5>
                            ...
                            <div class="submit-field">
                                <h5>{{ trans("dash.profile.username") }}</h5>
                            ...
                            <div class="submit-field">
                                <h5>{{ trans("dash.profile.email") }}</h5>
                            ...
                            <div class="submit-field">
                                <h5>{{ trans("dash.profile.mobile") }}</h5>
                            ...
                            <div class="submit-field">
                                <h5>{{ trans("dash.profile.role") }}</h5>
                                <select name="role_id" class="selectpicker with-border" data-size="7" title="{{ trans('dash.profile.select_one_role') }}" data-live-search="true">
                            ...
                            <div class="submit-field">
                                <h5>{{ trans("dash.profile.theme") }}</h5>
                                <select name="theme" class="selectpicker with-border" data-size="7" title="{{ trans('dash.items.select_one_type') }}" data-live-search="true">
                                    @foreach(['red' , 'yellow' , 'green' , 'blue'] as $value)
                                        <option @if($user->theme == $value ) selected @endif value="{{ $value }}">{{ trans("dash.profile.themes.{$value}") }}</option>
                                    @endforeach
                                </select>
                                @if($errors->has("theme"))
                            ...
                            <div class="submit-field">
                                <h5>{{ trans("dash.profile.gender") }}</h5>
                                <div class="account-type">
                                    @foreach(['male' => 'mdi-male-alt' , 'female' => 'mdi-female' ] as $gender => $icon )
                                        <div>
                                            ...
                                            <label for="{{ $gender }}-radio" class="ripple-effect-dark"><i class="icon-line-awesome-{{ $gender }}"></i>{{ trans("dash.profile.genders.$gender") }}</label>
                                        </div>
                                    @endforeach
                                </div>
                            ...
                            <div class="padding-bottom-20 pointer">
                                <label class="text-black">
                                    ...
                                    {{ trans("dash.profile.status.text") }}
                                    <i class="help-icon" data-tippy-placement="top" title="{{ trans("dash.profile.status.desc") }}"></i>
                                </label>
    ...
    <div class="col-xl-4">
        <form action="{{ route('dashboard.user.update' , $user->username ) }}" method="post">
            ...
            <div class="sidebar-widget">
                <h3>{{ trans("dash.profile.password") }}</h3>
            ...
            <div class="sidebar-widget">
                <h3>{{ trans("dash.profile.password_confirmation") }}</h3>
                <div class="input-with-icon">
                    <div id="autocomplete-container">
            ...
            <button class="button button-sliding-icon">
                {{ trans('dash.profile.changepassword.text') }}
                <i class="icon-material-outline-arrow-right-alt"></i>
            </button>
        </form>
    </div>
