...
@section('main')
    <div class="dashboard-box">
        <!-- Headline -->
        <div class="headline">
            <h3><i class="icon-material-outline-extension"></i>{{ trans('lora.permissions.edit.text_with_attr' , ['attribute' => $permission->name ]) }}</h3>
        </div>
        <div class="content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12">
                                <div class="checkbox">
                                    ...
                                    <label for="default"><span class="checkbox-icon"></span>{{ trans('lora.permissions.default.desc') }}</label>
                            ...
                            <div class="col-xl-12">
                                <button class="button button-sliding-icon margin-bottom-20">
                                    {{ trans('lora.permissions.edit.text') }}
